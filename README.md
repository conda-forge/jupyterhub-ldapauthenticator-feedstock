About jupyterhub-ldapauthenticator-feedstock
============================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyterhub-ldapauthenticator-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3051&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyterhub-ldapauthenticator-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyterhub-ldapauthenticator` can be installed with `conda`:
...
```
mamba install jupyterhub-ldapauthenticator
```

It is possible to list all of the versions of `jupyterhub-ldapauthenticator` available on your platform with `conda`:
...
```
mamba search jupyterhub-ldapauthenticator --channel conda-forge
```
...
mamba repoquery search jupyterhub-ldapauthenticator --channel conda-forge

# List packages depending on `jupyterhub-ldapauthenticator`:
mamba repoquery whoneeds jupyterhub-ldapauthenticator --channel conda-forge

# List dependencies of `jupyterhub-ldapauthenticator`:
mamba repoquery depends jupyterhub-ldapauthenticator --channel conda-forge
```
